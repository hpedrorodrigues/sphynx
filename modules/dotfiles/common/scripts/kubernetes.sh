...
function kgp() {
  ...
  kubectl get pods \
    ...
    | GREP_COLOR='01;31' grep --color=always -E 'Init:(ErrImagePull|CreateContainerConfigError|Error|CrashLoopBackOff|ImagePullBackOff|ContainerStatusUnknown|Unknown)|$' \
