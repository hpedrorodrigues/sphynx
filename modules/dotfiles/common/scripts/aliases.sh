...
alias kt='sx kubernetes tail'
alias kw='sx kubernetes watch'
alias ksv='sx kubernetes secret'
...
alias ktc='kubectl top pods --sort-by=cpu --all-namespaces'
alias ktm='kubectl top pods --sort-by=memory --all-namespaces'
